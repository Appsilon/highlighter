...
params:
   ...
   repo_name: highlighter
   repo_url: https://github.com/Appsilon/highlighter
   demo_url: http://appsilondatascience.com/demo
   chagelog_url: https://github.com/Appsilon/highlighter/blob/master/CHANGELOG.md
---
...
<div class="subheader">htmlwidgets wrapper for highlighter.js</div>

<div class="section level2">
This package is an htmlwidget wrapper for
an excelent highlight.js library. You can learn more
about javascript library https://highlightjs.org/.
